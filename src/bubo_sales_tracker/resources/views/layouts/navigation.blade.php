        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('sale.index') }}">
                        ...
                        @else
                            <h1 class="font-semibold text-xl text-gray-800 leading-tight">{{ Auth::user()->shop->shop_name }}</h1>
                        @endif
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if(Auth::user()->is_admin === 1)
                        ...
                        <x-nav-link :href="route('database.index')" :active="request()->routeIs('database.*')">
                            {{ __('バックアップ') }}
                        </x-nav-link>
                    @endif
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        @if(Auth::user()->is_admin === 1)
                            <x-dropdown-link target="_blank" :href="route('logs')">
                                {{ __('Logs') }}
                            </x-dropdown-link>
                        @endif
                        <!-- Authentication -->
