                    ...
                    <div class="shadow-md px-5 py-3 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                        <div class="relative flex flex-row justify-between items-center m-3">
                            ...
                            <input id="date" name="date" type="date" value="{{ old('date') }}" required
                                   class="w-full focus:border-blue-500 rounded-md sm:text-sm border-gray-300 text-right">
                        </div>
                        @if(Auth::user()->is_admin === 1)
                            <div class="relative flex flex-row justify-between items-center mx-3 mt-7">
                                ...
                                <select name="shop_id" required
                                        class="w-full focus:ring-blue-500 focus:border-blue-500 rounded-md sm:text-sm border-gray-300 text-right">
                        ...
                        <div class="relative flex flex-row justify-between items-center mx-3 mt-7">
                            ...
                            <input id="transaction_count" name="transaction_count" type="number" value="{{ old('transaction_count') }}" required
                        ...
                        <div class="relative flex flex-row justify-between items-center mx-3 mt-7 hidden lg:block">
                            ...
                            <input id="total-quantity" type="number" readonly
                                   class="w-full bg-gray-200 rounded-md sm:text-sm border-gray-300 text-right">
                        </div>
                        <div class="relative flex flex-row justify-between items-center mx-3 mt-7 hidden lg:block">
                        ...
                        <table class="w-full">
                            ...
                            @if(old('sku'))
                                @for($i = 0; $i < count(old('sku')); $i++)
                                    <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-2 lg:mb-0">
                                        ...
                                        <td class="w-full lg:w-auto p-3 text-gray-800 text-center border-b block lg:table-cell relative lg:static text-sm">
                                            ...
                                            <input id="quantity" name="quantity[]" type="number" required
                                               ...
                                               class="quantity focus:ring-blue-500 focus:border-blue-500 w-full rounded-md sm:text-sm border-gray-300">
                                        </td>
                                        <td class="w-full lg:w-auto p-3 text-gray-800 text-center border-b block lg:table-cell relative lg:static text-sm">
                            ...
                            @else
                                <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-2 lg:mb-0">
                                    ...
                                    <td class="w-full lg:w-auto p-3 text-gray-800 text-center border-b block lg:table-cell relative lg:static text-sm">
                                        <span
                                            class="lg:hidden absolute top-0 left-0 bg-blue-200 px-2 py-1 text-xs font-bold uppercase text-right">点数</span>
                                        <div>
                                            <div class="mt-1 flex rounded-md shadow-sm">
                                    ...
                                    <td class="w-full lg:w-auto p-3 text-gray-800 text-center border-b block lg:table-cell relative lg:static text-sm">
                                    <span
                                        class="lg:hidden absolute top-0 left-0 bg-blue-200 px-2 py-1 text-xs font-bold uppercase text-right">小計</span>
                                        <div>
                    ...
                    <div class="min-w-0 md:col-span-1 mt-5">
                        <footer class="bg-white shadow-md font-bold py-2 px-4 border-t-2 border-blue-800 hover:border-blue inset-x-0 bottom-0 p-3 fixed lg:hidden">
                            <div class="relative flex flex-row justify-end mx-4 mt-1">
                                ...
                                <p id="sm-total-quantity" class="w-24 sm:text-sm text-right"></p>
                            </div>

                            <div class="relative flex flex-row justify-end mx-4 mt-1">
                                <span class="w-24 text-right font-bold text-gray-600">金額合計 :</span>
                                <p id="sm-total-amount" class="w-24 sm:text-sm text-right"></p>
                            </div>
